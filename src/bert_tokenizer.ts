...
import VOCAB_RAW from "./vocab.json?raw";
...
export class BertTokenizer {
    ...
    private tokenizeChineseChars(text: string): string {
        return text.replace(
            /[\u{4E00}-\u{9FFF}\u{3400}-\u{4DBF}\u{20000}-\u{2A6DF}\u{2A700}-\u{2B73F}\u{2B740}-\u{2B81F}\u{2B820}-\u{2CEAF}\u{F900}-\u{FAFF}\u{2F800}-\u{2FA1F}]/gu,
            (r) => ` ${r} `
        );
    }
